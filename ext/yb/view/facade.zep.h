...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_view_facade_content, 0, 0, 0)
	ZEND_ARG_INFO(0, content)
	ZEND_ARG_INFO(0, contentType)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_view_facade_httpresponse, 0, 0, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_view_facade_readfile, 0, 0, 0)
	ZEND_ARG_INFO(0, readFile)
	ZEND_ARG_INFO(0, readFileContentType)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_view_facade_redirect, 0, 0, 0)
	ZEND_ARG_INFO(0, redirectUrl)
	ZEND_ARG_INFO(0, redirectDataAsQueries)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_view_facade_tpl, 0, 0, 0)

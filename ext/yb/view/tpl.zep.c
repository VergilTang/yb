...
PHP_METHOD(Yb_View_Tpl, run) {
	...
	ZEPHIR_INIT_NVAR(_3);
	ZVAL_STRING(_3, "", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_CE_STATIC(&_10, yb_std_ce, "valueat", &_1, 9, options, _2, _3);
	zephir_check_temp_parameter(_2);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_15, yb_std_ce, "valueat", &_1, 9, options, _3, _16);
	zephir_check_temp_parameter(_3);
	...
	ZEPHIR_CALL_CE_STATIC(&_18, yb_std_ce, "valueat", &_1, 9, options, _3, _16);
	zephir_check_temp_parameter(_3);
	zephir_check_temp_parameter(_16);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_34, yb_std_ce, "renderscript", &_35, 147, path, data);
	zephir_check_call_status();

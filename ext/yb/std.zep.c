...
PHP_METHOD(Yb_Std, sizeToBytes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("floatval", NULL, 110, size);
...
PHP_METHOD(Yb_Std, tr) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 107, message, r);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Std, newInstanceOf) {
	...
	ZEPHIR_CALL_FUNCTION(&a, "array_values", NULL, 108, args);
	zephir_check_call_status();
	do {
		if (c == 1) {
...
PHP_METHOD(Yb_Std, throwError) {
	...
	ZEPHIR_INIT_VAR(_3);
	ZVAL_LONG(_3, n);
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 112, _2, _3);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Std, outputScript) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "extract", NULL, 113, data, _2, _3);
...
PHP_METHOD(Yb_Std, renderScript) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "ob_implicit_flush", NULL, 20, ZEPHIR_GLOBAL(global_false));
	zephir_check_call_status();
	...
	/* try_start_1: */
		...
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", NULL, 21);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM();
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(ex, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "ob_end_clean", NULL, 22);
			zephir_check_call_status();

...
PHP_METHOD(Yb_Std, sizeToBytes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("floatval", NULL, 114, size);
...
PHP_METHOD(Yb_Std, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mt_rand", NULL, 115);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "uniqid", NULL, 116, _0, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
...
PHP_METHOD(Yb_Std, randString) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "mb_strlen", NULL, 64, charList, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$5, "mb_substr", &_9, 67, charList, &_5$$5, &_6$$5, &_7$$5);
		zephir_check_call_status();
...
PHP_METHOD(Yb_Std, tr) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 102, message, r);
	zephir_check_call_status();
	RETURN_MM();

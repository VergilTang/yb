...
PHP_METHOD(Yb_Std, sizeToBytes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("floatval", NULL, 73, size);
...
PHP_METHOD(Yb_Std, bytesToSize) {
	...
	ZVAL_LONG(&_17, 0);
	ZEPHIR_RETURN_CALL_FUNCTION("strval", NULL, 74, &_17);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Std, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mt_rand", NULL, 75);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "uniqid", NULL, 76, _0, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
...
PHP_METHOD(Yb_Std, tr) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 77, message, r);
	zephir_check_call_status();
	RETURN_MM();

...
PHP_METHOD(Yb_Std, bytesToSize) {
	...
	ZVAL_LONG(&_17, 0);
	ZEPHIR_RETURN_CALL_FUNCTION("strval", NULL, 113, &_17);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Std, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mt_rand", NULL, 116);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "uniqid", NULL, 117, _0, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
...
PHP_METHOD(Yb_Std, randString) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "mb_strlen", NULL, 65, charList, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$5, "mb_substr", &_9, 68, charList, &_5$$5, &_6$$5, &_7$$5);
		zephir_check_call_status();
...
PHP_METHOD(Yb_Std, throwError) {
	...
	ZEPHIR_INIT_VAR(_3);
	ZVAL_LONG(_3, n);
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 118, _2, _3);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Std, outputScript) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "extract", NULL, 119, data, _2, _3);
...
PHP_METHOD(Yb_Std, renderScript) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "ob_start", NULL, 22);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "ob_implicit_flush", NULL, 23, ZEPHIR_GLOBAL(global_false));
	zephir_check_call_status();
	...
	/* try_start_1: */
		...
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", NULL, 24);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM();

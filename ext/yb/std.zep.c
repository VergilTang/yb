...
PHP_METHOD(Yb_Std, sizeToBytes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("floatval", NULL, 79, size);
...
PHP_METHOD(Yb_Std, bytesToSize) {
	...
	ZVAL_LONG(&_17, 0);
	ZEPHIR_RETURN_CALL_FUNCTION("strval", NULL, 80, &_17);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Std, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mt_rand", NULL, 81);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "uniqid", NULL, 82, _0, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
	ZEPHIR_CONCAT_VV(_2, _1, salt);
	ZEPHIR_CALL_FUNCTION(&_3, "sha1", NULL, 83, _2);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_4);
	zephir_time(_4);
	ZEPHIR_SINIT_VAR(_5);
...
PHP_METHOD(Yb_Std, randString) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "mb_strlen", NULL, 56, charList, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$5, "mb_substr", &_9, 59, charList, &_5$$5, &_6$$5, &_7$$5);
		zephir_check_call_status();
...
PHP_METHOD(Yb_Std, tr) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 84, message, r);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Std, throwError) {
	...
	ZEPHIR_INIT_VAR(_3);
	ZVAL_LONG(_3, n);
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 85, _2, _3);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Std, outputScript) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "extract", NULL, 86, data, _2, _3);

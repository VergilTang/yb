...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_parsegroupedaggregation, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_querygroupedaggregation, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

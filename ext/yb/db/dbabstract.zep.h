...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_profiledquery, 0, 0, 3)
	ZEND_ARG_INFO(0, q)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_selectunionall, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_countandselectunionall, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, selects, 0)
	ZEND_ARG_INFO(0, orderBy)
	ZEND_ARG_INFO(0, limit)
	ZEND_ARG_INFO(0, skip)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_aggregations, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, aggregations, 0)
	ZEND_ARG_ARRAY_INFO(0, where, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_aggregation, 0, 0, 3)
	ZEND_ARG_INFO(0, table)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_avg, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_INFO(0, column)
	ZEND_ARG_ARRAY_INFO(0, where, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_groupaggregations, 0, 0, 3)
	ZEND_ARG_INFO(0, table)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_savepoint, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_insertsql, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, data, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_deletesql, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, where, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_updatesql, 0, 0, 3)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, data, 0)
	ZEND_ARG_ARRAY_INFO(0, where, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_selectsql, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_selectcountsql, 0, 0, 2)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_selectunionallsql, 0, 0, 4)
	ZEND_ARG_ARRAY_INFO(0, selects, 0)
	ZEND_ARG_INFO(0, orderBy)
	ZEND_ARG_INFO(0, limit)
	ZEND_ARG_INFO(0, skip)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_selectcountunionallsql, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, selects, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_aggregationssql, 0, 0, 3)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, aggregations, 0)
	ZEND_ARG_ARRAY_INFO(0, where, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_aggregationsql, 0, 0, 4)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_INFO(0, column)
	ZEND_ARG_INFO(0, aggregation)
	ZEND_ARG_ARRAY_INFO(0, where, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_groupaggregationssql, 0, 0, 4)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_INFO(0, groupBy)
	ZEND_ARG_ARRAY_INFO(0, aggregations, 0)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_wheresql, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, where, 0)
	ZEND_ARG_INFO(0, sep)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_wheremultipleinsql, 0, 0, 2)
	ZEND_ARG_INFO(0, columns)
	ZEND_ARG_ARRAY_INFO(0, values, 0)
	ZEND_ARG_INFO(0, isNot)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_dbabstract_paginationsql, 0, 0, 3)
...
ZEPHIR_INIT_FUNCS(yb_db_dbabstract_method_entry) {
	PHP_ME(Yb_Db_DbAbstract, profiledQuery, arginfo_yb_db_dbabstract_profiledquery, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Yb_Db_DbAbstract, selectUnionAll, arginfo_yb_db_dbabstract_selectunionall, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, countAndSelectUnionAll, arginfo_yb_db_dbabstract_countandselectunionall, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, aggregations, arginfo_yb_db_dbabstract_aggregations, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, aggregation, arginfo_yb_db_dbabstract_aggregation, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Yb_Db_DbAbstract, avg, arginfo_yb_db_dbabstract_avg, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, groupAggregations, arginfo_yb_db_dbabstract_groupaggregations, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Yb_Db_DbAbstract, insertSql, arginfo_yb_db_dbabstract_insertsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, deleteSql, arginfo_yb_db_dbabstract_deletesql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, updateSql, arginfo_yb_db_dbabstract_updatesql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, selectSql, arginfo_yb_db_dbabstract_selectsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, selectCountSql, arginfo_yb_db_dbabstract_selectcountsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, selectUnionAllSql, arginfo_yb_db_dbabstract_selectunionallsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, selectCountUnionAllSql, arginfo_yb_db_dbabstract_selectcountunionallsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, aggregationsSql, arginfo_yb_db_dbabstract_aggregationssql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, aggregationSql, arginfo_yb_db_dbabstract_aggregationsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, groupAggregationsSql, arginfo_yb_db_dbabstract_groupaggregationssql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, whereSql, arginfo_yb_db_dbabstract_wheresql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, whereMultipleInSql, arginfo_yb_db_dbabstract_wheremultipleinsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, paginationSql, arginfo_yb_db_dbabstract_paginationsql, ZEND_ACC_ABSTRACT|ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_DbAbstract, randomOrderSql, NULL, ZEND_ACC_ABSTRACT|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Yb_Db_DbAbstract, nextFlag, arginfo_yb_db_dbabstract_nextflag, ZEND_ACC_PROTECTED)
	PHP_FE_END
};

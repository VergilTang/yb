...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_db_pdomysql_paginationsql, 0, 0, 3)
...
ZEPHIR_INIT_FUNCS(yb_db_pdomysql_method_entry) {
	...
	PHP_ME(Yb_Db_PdoMysql, paginationSql, arginfo_yb_db_pdomysql_paginationsql, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Db_PdoMysql, randomOrderSql, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};

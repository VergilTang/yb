...
ZEPHIR_INIT_CLASS(Yb_Db_Entity) {
	...
	ZEPHIR_REGISTER_CLASS(Yb\\Db, Entity, yb, db_entity, yb_db_entity_method_entry, 0);

	zend_declare_property_null(yb_db_entity_ce, SL("model"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yb_db_entity_ce, SL("row"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yb_db_entity_ce, SL("isNew"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yb_db_entity_ce, SL("updates"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yb_db_entity_ce, SL("collection"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Yb_Db_Entity, set) {
	...
	zephir_is_iterable(updates, &_1, &_0, 0, 0, "yb/db/entity.zep", 70);
	for (
...
PHP_METHOD(Yb_Db_Entity, save) {
	...
	zephir_is_iterable(row, &_10, &_9, 0, 0, "yb/db/entity.zep", 114);
	for (

...
PHP_METHOD(Yb_Image_Gd, __construct) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "gd", 0);
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", NULL, 15, &_0);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_1))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Missing extension: gd", "yb/image/gd.zep", 8);
		return;
	}
	ZEPHIR_CALL_PARENT(NULL, yb_image_gd_ce, this_ptr, "__construct", &_2, 39, defaultOptions);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Gd, text) {
	...
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_LONG(&_2, 0);
	ZEPHIR_CALL_FUNCTION(&box, "imagettfbbox", NULL, 40, _0, &_2, _1, text);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(box))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "imagettfbbox", "yb/image/gd.zep", 25);
		return;
	}
	ZEPHIR_OBS_VAR(_3);
...
PHP_METHOD(Yb_Image_Gd, fromPath) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *path_param = NULL, *extension_param = NULL, *eit = NULL, *im = NULL, *handler = NULL, *_4 = NULL, *_5 = NULL, *_6 = NULL, *_0$$3, *_2$$7, *_3$$7, *_7$$9 = NULL, *_8$$9, *_9$$10 = NULL;
	zval *path = NULL, *extension = NULL, *_1$$3;
	...
	ZEPHIR_CALL_FUNCTION(&eit, "exif_imagetype", NULL, 41, path);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(eit))) {
		ZEPHIR_INIT_VAR(_0$$3);
		object_init_ex(_0$$3, yb_image_exception_ce);
		ZEPHIR_INIT_VAR(_1$$3);
		ZEPHIR_CONCAT_SV(_1$$3, "Not an image file: ", path);
		ZEPHIR_CALL_METHOD(NULL, _0$$3, "__construct", NULL, 2, _1$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(_0$$3, "yb/image/gd.zep", 68 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	do {
		if (ZEPHIR_IS_LONG(eit, 1)) {
			ZEPHIR_CALL_FUNCTION(&handler, "imagecreatefromgif", NULL, 42, path);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(eit, 2)) {
			ZEPHIR_CALL_FUNCTION(&handler, "imagecreatefromjpeg", NULL, 43, path);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(eit, 3)) {
			ZEPHIR_CALL_FUNCTION(&handler, "imagecreatefrompng", NULL, 44, path);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_INIT_VAR(_2$$7);
		object_init_ex(_2$$7, yb_image_exception_ce);
		ZEPHIR_INIT_VAR(_3$$7);
		ZEPHIR_CONCAT_SV(_3$$7, "Unsupported image type: ", eit);
		ZEPHIR_CALL_METHOD(NULL, _2$$7, "__construct", NULL, 2, _3$$7);
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$7, "yb/image/gd.zep", 83 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 45, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 46, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&im, this_ptr, "newimage", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(im, SL("handler"), handler TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_4, "imagesx", NULL, 47, handler);
	zephir_check_call_status();
	zephir_update_property_zval(im, SL("width"), _4 TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_5, "imagesy", NULL, 48, handler);
	zephir_check_call_status();
	zephir_update_property_zval(im, SL("height"), _5 TSRMLS_CC);
	if (zephir_fast_strlen_ev(extension) > 0) {
		ZEPHIR_INIT_VAR(_8$$9);
		zephir_fast_strtolower(_8$$9, extension);
		zephir_update_property_zval(im, SL("extension"), _8$$9 TSRMLS_CC);
	} else {
		ZEPHIR_CALL_FUNCTION(&_9$$10, "image_type_to_extension", NULL, 49, eit, ZEPHIR_GLOBAL(global_false));
		zephir_check_call_status();
		zephir_update_property_zval(im, SL("extension"), _9$$10 TSRMLS_CC);
	}
	RETURN_CCTOR(im);
...
PHP_METHOD(Yb_Image_Gd, fromString) {
	...
	ZEPHIR_CALL_FUNCTION(&handler, "imagecreatefromstring", NULL, 50, data);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(handler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Cannot create image: imagecreatefromstring", "yb/image/gd.zep", 114);
		return;
	}
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 45, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_update_property_zval(im, SL("handler"), handler TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_0, "imagesx", NULL, 47, handler);
	zephir_check_call_status();
	zephir_update_property_zval(im, SL("width"), _0 TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "imagesy", NULL, 48, handler);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Gd, captcha) {
	...
	while (1) {
		...
		ZVAL_LONG(&_25$$4, b);
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 52, handler, &_23$$4, &_24$$4, &_25$$4);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_23$$4);
		ZVAL_LONG(&_23$$4, i);
		ZEPHIR_SINIT_NVAR(_24$$4);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 53, handler, &_23$$4, &_24$$4, &_25$$4, &_27$$4, color);
		zephir_check_call_status();
		r -= dr;
		g -= dg;
		b -= db;
	...
	ZVAL_LONG(&_31, 0);
	ZEPHIR_CALL_FUNCTION(&shadow, "imagecolorallocate", &_26, 52, handler, &_29, &_30, &_31);
	zephir_check_call_status();
	x = padding;
	i = 0;
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_41$$5, "mb_substr", &_42, 54, text, &_38$$5, &_39$$5, &_40$$5);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 52, handler, &_47$$5, &_48$$5, &_49$$5);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_47$$5);
		...
		ZVAL_LONG(&_50$$5, (y + 1));
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", &_51, 55, handler, &_47$$5, &_48$$5, &_49$$5, &_50$$5, shadow, font, ch);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_47$$5);
		ZVAL_LONG(&_47$$5, fontSize);
		ZEPHIR_SINIT_NVAR(_48$$5);
		...
		ZEPHIR_SINIT_NVAR(_50$$5);
		ZVAL_LONG(&_50$$5, y);
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", &_51, 55, handler, &_47$$5, &_48$$5, &_49$$5, &_50$$5, color, font, ch);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 52, handler, &_58$$7, &_59$$7, &_60$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_58$$7);
		ZVAL_LONG(&_58$$7, 0);
		ZEPHIR_SINIT_NVAR(_59$$7);
		...
		while (1) {
			...
			ZVAL_LONG(&_69$$8, y2);
			ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 53, handler, &_66$$8, &_67$$8, &_68$$8, &_69$$8, color);
			zephir_check_call_status();
			j++;
		}
		...
		ZVAL_LONG(&_73$$7, y2);
		ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 53, handler, &_70$$7, &_71$$7, &_72$$7, &_73$$7, shadow);
		zephir_check_call_status();
		i++;
	}
	RETURN_CCTOR(im);
...
PHP_METHOD(Yb_Image_Gd, largest) {
...
PHP_METHOD(Yb_Image_Gd, resize) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument width must be positive", "yb/image/gd.zep", 253);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Yb_Image_Gd, crop) {
	...
	if (unlikely(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Arguments x and y must not be negative", "yb/image/gd.zep", 285);
		return;
	}
	if (unlikely(w < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument w must be positive", "yb/image/gd.zep", 289);
		return;
	}
	if (h < 1) {
		h = w;
	...
	if (unlikely(_2)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Cropping out of area", "yb/image/gd.zep", 297);
		return;
	}
	ZEPHIR_OBS_VAR(_4);
	zephir_read_property(&_4, im, SL("extension"), PH_NOISY_CC);
...
PHP_METHOD(Yb_Image_Gd, thumbnail) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Width must be positive", "yb/image/gd.zep", 312);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Yb_Image_Gd, draw) {
	...
	zephir_check_call_status();
	do {
		if (zephir_instance_of_ev(srcIm, yb_image_image_ce TSRMLS_CC)) {
		...
		object_init_ex(_6$$3, yb_image_exception_ce);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_6$$3, "yb/image/gd.zep", 368 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while (0);
...
PHP_METHOD(Yb_Image_Gd, save) {
	...
	do {
		if (ZEPHIR_IS_STRING(_0, "png")) {
			...
			ZEPHIR_CALL_FUNCTION(&_3$$3, "imagepng", NULL, 56, _1$$3, _2$$3);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "gif")) {
			...
			ZEPHIR_CALL_FUNCTION(&_6$$5, "imagegif", NULL, 57, _4$$5, _5$$5);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "jpg") || ZEPHIR_IS_STRING(_0, "jpeg")) {
			...
			ZVAL_LONG(&_9$$7, 100);
			ZEPHIR_CALL_FUNCTION(&_10$$7, "imagejpeg", NULL, 58, _7$$7, _8$$7, &_9$$7);
			zephir_check_call_status();
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_11$$9, "yb/image/gd.zep", 397 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);

	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Cannot save image", "yb/image/gd.zep", 400);
	return;
...
PHP_METHOD(Yb_Image_Gd, destroy) {
	...
	if (zephir_instance_of_ev(im, yb_image_image_ce TSRMLS_CC)) {
		ZEPHIR_OBS_VAR(_0$$3);
		zephir_read_property(&_0$$3, im, SL("handler"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 59, _0$$3);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Gd, createGdImageFromSize) {
	...
	if (width < 1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Width must be positive", "yb/image/gd.zep", 415);
		return;
	}
	if (height < 1) {
		height = width;
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, height);
	ZEPHIR_CALL_FUNCTION(&handler, "imagecreatetruecolor", NULL, 60, &_0, &_1);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(handler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Cannot create image: imagecreatetruecolor", "yb/image/gd.zep", 424);
		return;
	}
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 45, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, 127);
	ZEPHIR_CALL_FUNCTION(&background, "imagecolorallocatealpha", NULL, 61, handler, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagecolortransparent", NULL, 62, handler, background);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 0);
	ZEPHIR_SINIT_NVAR(_1);
	ZVAL_LONG(&_1, 0);
	ZEPHIR_CALL_FUNCTION(NULL, "imagefill", NULL, 63, handler, &_0, &_1, background);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(im);
	object_init(im);
	zephir_update_property_zval(im, SL("handler"), handler TSRMLS_CC);
...
PHP_METHOD(Yb_Image_Gd, drawText) {
	...
	if (zephir_is_true(_0)) {
		zephir_array_fetch_long(&_3$$3, m, 1, PH_NOISY | PH_READONLY, "yb/image/gd.zep", 449 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "hexdec", &_5, 64, _3$$3);
		zephir_check_call_status();
		r = zephir_get_intval(_4$$3);
		zephir_array_fetch_long(&_6$$3, m, 2, PH_NOISY | PH_READONLY, "yb/image/gd.zep", 450 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_7$$3, "hexdec", &_5, 64, _6$$3);
		zephir_check_call_status();
		g = zephir_get_intval(_7$$3);
		zephir_array_fetch_long(&_8$$3, m, 3, PH_NOISY | PH_READONLY, "yb/image/gd.zep", 451 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_9$$3, "hexdec", &_5, 64, _8$$3);
		zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_17);
	ZVAL_LONG(&_17, alpha);
	ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 61, handler, &_14, &_15, &_16, &_17);
	zephir_check_call_status();
	ZEPHIR_OBS_NVAR(_12);
	...
	ZVAL_LONG(&_16, y);
	ZEPHIR_CALL_FUNCTION(&_20, "imagettftext", NULL, 55, handler, _12, &_14, &_15, &_16, color, _18, _19);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_20))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "imagettftext", "yb/image/gd.zep", 463);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Gd, copy) {
	...
	ZEPHIR_SINIT_VAR(_7);
	ZVAL_LONG(&_7, 0);
	ZEPHIR_CALL_FUNCTION(&_8, "imagecopy", NULL, 65, _0, _1, &_4, &_5, &_6, &_7, _2, _3);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_8))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "imagecopy", "yb/image/gd.zep", 470);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Gd, copyResampled) {
	...
	ZEPHIR_SINIT_VAR(_9);
	ZVAL_LONG(&_9, srcH);
	ZEPHIR_CALL_FUNCTION(&_10, "imagecopyresampled", NULL, 66, _0, _1, &_2, &_3, &_4, &_5, &_6, &_7, &_8, &_9);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_10))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "imagecopyresampled", "yb/image/gd.zep", 479);
		return;
	}
	ZEPHIR_MM_RESTORE();

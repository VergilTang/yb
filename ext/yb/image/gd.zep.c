...
PHP_METHOD(Yb_Image_Gd, captcha) {
	...
	while (1) {
		...
		ZVAL_LONG(&_25$$4, b);
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 53, handler, &_23$$4, &_24$$4, &_25$$4);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_23$$4);
		ZVAL_LONG(&_23$$4, i);
		ZEPHIR_SINIT_NVAR(_24$$4);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 54, handler, &_23$$4, &_24$$4, &_25$$4, &_27$$4, color);
		zephir_check_call_status();
		r -= dr;
		g -= dg;
		b -= db;
	...
	ZVAL_LONG(&_31, 0);
	ZEPHIR_CALL_FUNCTION(&shadow, "imagecolorallocate", &_26, 53, handler, &_29, &_30, &_31);
	zephir_check_call_status();
	x = padding;
	i = 0;
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_41$$5, "mb_substr", &_42, 55, text, &_38$$5, &_39$$5, &_40$$5);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 53, handler, &_47$$5, &_48$$5, &_49$$5);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_47$$5);
		...
		ZVAL_LONG(&_50$$5, (y + 1));
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", &_51, 56, handler, &_47$$5, &_48$$5, &_49$$5, &_50$$5, shadow, font, ch);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_47$$5);
		ZVAL_LONG(&_47$$5, fontSize);
		ZEPHIR_SINIT_NVAR(_48$$5);
		...
		ZEPHIR_SINIT_NVAR(_50$$5);
		ZVAL_LONG(&_50$$5, y);
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", &_51, 56, handler, &_47$$5, &_48$$5, &_49$$5, &_50$$5, color, font, ch);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocate", &_26, 53, handler, &_58$$7, &_59$$7, &_60$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_58$$7);
		ZVAL_LONG(&_58$$7, 0);
		ZEPHIR_SINIT_NVAR(_59$$7);
		...
		while (1) {
			...
			ZVAL_LONG(&_69$$8, y2);
			ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 54, handler, &_66$$8, &_67$$8, &_68$$8, &_69$$8, color);
			zephir_check_call_status();
			j++;
		}
		...
		ZVAL_LONG(&_73$$7, y2);
		ZEPHIR_CALL_FUNCTION(NULL, "imageline", &_28, 54, handler, &_70$$7, &_71$$7, &_72$$7, &_73$$7, shadow);
		zephir_check_call_status();
		i++;
	}
	RETURN_CCTOR(im);
...
PHP_METHOD(Yb_Image_Gd, save) {
	...
	do {
		if (ZEPHIR_IS_STRING(_0, "png")) {
			...
			ZEPHIR_CALL_FUNCTION(&_3$$3, "imagepng", NULL, 57, _1$$3, _2$$3);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "gif")) {
			...
			ZEPHIR_CALL_FUNCTION(&_6$$5, "imagegif", NULL, 58, _4$$5, _5$$5);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "jpg") || ZEPHIR_IS_STRING(_0, "jpeg")) {
			...
			ZVAL_LONG(&_9$$7, 100);
			ZEPHIR_CALL_FUNCTION(&_10$$7, "imagejpeg", NULL, 59, _7$$7, _8$$7, &_9$$7);
			zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Gd, destroy) {
	...
	if (zephir_instance_of_ev(im, yb_image_image_ce TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 60, _0$$3);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Gd, createGdImageFromSize) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, height);
	ZEPHIR_CALL_FUNCTION(&handler, "imagecreatetruecolor", NULL, 61, &_0, &_1);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(handler))) {
...
PHP_METHOD(Yb_Image_Gd, drawText) {
	...
	ZEPHIR_SINIT_VAR(_17);
	ZVAL_LONG(&_17, alpha);
	ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 62, handler, &_14, &_15, &_16, &_17);
	zephir_check_call_status();
	ZEPHIR_OBS_NVAR(_12);
	...
	ZVAL_LONG(&_16, y);
	ZEPHIR_CALL_FUNCTION(&_20, "imagettftext", NULL, 56, handler, _12, &_14, &_15, &_16, color, _18, _19);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Gd, copy) {
	...
	ZEPHIR_SINIT_VAR(_7);
	ZVAL_LONG(&_7, 0);
	ZEPHIR_CALL_FUNCTION(&_8, "imagecopy", NULL, 66, _0, _1, &_4, &_5, &_6, &_7, _2, _3);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Gd, copyResampled) {
	...
	ZEPHIR_SINIT_VAR(_9);
	ZVAL_LONG(&_9, srcH);
	ZEPHIR_CALL_FUNCTION(&_10, "imagecopyresampled", NULL, 67, _0, _1, &_2, &_3, &_4, &_5, &_6, &_7, &_8, &_9);
	zephir_check_call_status();

...
PHP_METHOD(Yb_Image_Imagick, __construct) {
	...
	if (unlikely(!zephir_is_true(_1))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Missing extension: imagick", "yb/image/imagick.zep", 8);
		return;
	}
	ZEPHIR_CALL_PARENT(NULL, yb_image_imagick_ce, this_ptr, "__construct", &_2, 5, defaults);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Image_Imagick, text) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, imProperties, SL("font"), PH_NOISY | PH_READONLY, "yb/image/imagick.zep", 23 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, imgickDraw, "setfont", NULL, 0, _0);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, imProperties, SL("fontSize"), PH_NOISY | PH_READONLY, "yb/image/imagick.zep", 24 TSRMLS_CC);
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_2);
	zephir_array_fetch_string(&_2, imProperties, SL("padding"), PH_NOISY, "yb/image/imagick.zep", 27 TSRMLS_CC);
	padding2 = (2 * zephir_get_intval(_2));
	zephir_array_update_string(&imProperties, SL("text"), &text, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_string(&_3, m, SL("textWidth"), PH_NOISY | PH_READONLY, "yb/image/imagick.zep", 30 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_4);
	ZVAL_LONG(_4, (zephir_get_numberval(_3) + padding2));
	zephir_array_update_string(&imProperties, SL("width"), &_4, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_string(&_5, m, SL("textHeight"), PH_NOISY | PH_READONLY, "yb/image/imagick.zep", 31 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_6);
...
PHP_METHOD(Yb_Image_Imagick, captcha) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_0);
	zephir_array_fetch_string(&_0, validOptions, SL("font"), PH_NOISY, "yb/image/imagick.zep", 45 TSRMLS_CC);
	zephir_get_strval(_1, _0);
	ZEPHIR_CPY_WRT(font, _1);
	ZEPHIR_OBS_VAR(_2);
	zephir_array_fetch_string(&_2, validOptions, SL("rPadding"), PH_NOISY, "yb/image/imagick.zep", 46 TSRMLS_CC);
	rPadding = zephir_get_doubleval(_2);
	ZEPHIR_OBS_VAR(_3);
	zephir_array_fetch_string(&_3, validOptions, SL("rOverlap"), PH_NOISY, "yb/image/imagick.zep", 47 TSRMLS_CC);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_41$$5, "mb_substr", &_42, 11, code, &_38$$5, &_39$$5, &_40$$5);
		zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Imagick, fromSize) {
	...
	array_init(imProperties);
	if (width < 1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument width must be positive", "yb/image/imagick.zep", 156);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Yb_Image_Imagick, fromPath) {
	...
	ZEPHIR_CALL_METHOD(NULL, imagick, "__construct", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "realpath", NULL, 37, path);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Imagick, resize) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument width must be positive", "yb/image/imagick.zep", 229);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Yb_Image_Imagick, crop) {
	...
	if (unlikely(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Arguments x and y must not be negative", "yb/image/imagick.zep", 252);
		return;
	}
	if (unlikely(w < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument w must be positive", "yb/image/imagick.zep", 256);
		return;
	}
	if (h < 1) {
		h = w;
	...
	if (unlikely(_2)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Cropping out of area", "yb/image/imagick.zep", 264);
		return;
	}
	ZEPHIR_CALL_METHOD(&destIm, this_ptr, "fromimage", NULL, 0, im);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Image_Imagick, thumbnail) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(yb_image_exception_ce, "Argument width must be positive", "yb/image/imagick.zep", 281);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Yb_Image_Imagick, draw) {
	...
	ZEPHIR_INIT_VAR(_16);
	object_init_ex(_16, yb_image_exception_ce);
	ZEPHIR_INIT_VAR(_17);
	zephir_get_class(_17, srcIm, 0 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_18);
	ZEPHIR_CONCAT_SV(_18, "Invalid item type: ", _17);
	ZEPHIR_CALL_METHOD(NULL, _16, "__construct", NULL, 23, _18);
	zephir_check_call_status();
	zephir_throw_exception_debug(_16, "yb/image/imagick.zep", 325 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Yb_Image_Imagick, save) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *destPath = NULL;
	zval *im, *destPath_param = NULL, *_0 = NULL, *_1$$3, *_2$$4, *_3$$4 = NULL;
	...
	if (zephir_fast_strlen_ev(destPath) > 0) {
		ZEPHIR_OBS_VAR(_1$$3);
		zephir_read_property(&_1$$3, im, SL("imagick"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "writeimage", NULL, 0, destPath);
		zephir_check_call_status();
	} else {
		ZEPHIR_OBS_VAR(_2$$4);
		zephir_read_property(&_2$$4, im, SL("imagick"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(&_3$$4, _2$$4, "getimageblob", NULL, 0);
		zephir_check_call_status();

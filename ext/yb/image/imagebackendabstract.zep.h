...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_image_imagebackendabstract___construct, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, defaults, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_image_imagebackendabstract_setdefaults, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, defaults, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_image_imagebackendabstract_setdefault, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_image_imagebackendabstract_validtextoptions, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_image_imagebackendabstract_validcaptchaoptions, 0, 0, 1)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(yb_image_imagebackendabstract_method_entry) {
	...
	PHP_ME(Yb_Image_ImageBackendAbstract, setDefaults, arginfo_yb_image_imagebackendabstract_setdefaults, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Image_ImageBackendAbstract, setDefault, arginfo_yb_image_imagebackendabstract_setdefault, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Yb_Image_ImageBackendAbstract, validTextOptions, arginfo_yb_image_imagebackendabstract_validtextoptions, ZEND_ACC_PROTECTED)
	PHP_ME(Yb_Image_ImageBackendAbstract, validCaptchaOptions, arginfo_yb_image_imagebackendabstract_validcaptchaoptions, ZEND_ACC_PROTECTED)
	PHP_FE_END
};

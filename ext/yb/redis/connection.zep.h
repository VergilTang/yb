...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_redis_connection_newerror, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(yb_redis_connection_method_entry) {
	...
	PHP_ME(Yb_Redis_Connection, getSocket, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Yb_Redis_Connection, newError, arginfo_yb_redis_connection_newerror, ZEND_ACC_PROTECTED)
	PHP_FE_END
};

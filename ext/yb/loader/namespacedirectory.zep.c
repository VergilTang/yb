...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, yb_loader_namespacedirectory_ce, this_ptr, "__construct", &_0, 74, _1);
...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __invoke) {
	...
	while (1) {
		...
		ZVAL_STRING(&_1$$3, "\\", 0);
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_2, 76, match, &_1$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_12, yb_loader_loaderabstract_ce, "isloaded", &_13, 75, name);
	zephir_check_call_status();

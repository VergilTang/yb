...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __construct) {
	...
	zephir_is_iterable(namespaceDirectories, &_1, &_0, 0, 0, "yb/loader/namespacedirectory.zep", 18);
	for (
...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __invoke) {
	...
	while (1) {
		...
		ZVAL_STRING(&_1$$3, "\\", 0);
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", &_2, 41, match, &_1$$3);
	...
	if (unlikely(_6)) {
		...
		object_init_ex(_7$$7, yb_loader_exception_ce);
		ZEPHIR_INIT_VAR(_8$$7);
		ZEPHIR_CONCAT_SV(_8$$7, "Invalid namespace directory options: ", match);
		ZEPHIR_CALL_METHOD(NULL, _7$$7, "__construct", NULL, 3, _8$$7);
		zephir_check_call_status();
		zephir_throw_exception_debug(_7$$7, "yb/loader/namespacedirectory.zep", 44 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_SINIT_VAR(_9);
	...
	zephir_array_fetch_long(&_11, arr, 1, PH_NOISY | PH_READONLY, "yb/loader/namespacedirectory.zep", 48 TSRMLS_CC);
	if (zephir_is_true(_11)) {
		ZEPHIR_INIT_VAR(_12$$8);
		zephir_fast_strtolower(_12$$8, path);
		zephir_get_strval(path, _12$$8);
	}
	zephir_array_fetch_long(&_13, arr, 0, PH_NOISY | PH_READONLY, "yb/loader/namespacedirectory.zep", 51 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_14);
	...
	if (unlikely(!(zephir_class_exists(className, zephir_is_true(ZEPHIR_GLOBAL(global_false))  TSRMLS_CC)))) {
		...
		object_init_ex(_18$$10, yb_loader_exception_ce);
		ZEPHIR_INIT_VAR(_19$$10);
		ZEPHIR_CONCAT_SVSV(_19$$10, "Cannot find class: ", className, ", in path: ", path);
		ZEPHIR_CALL_METHOD(NULL, _18$$10, "__construct", NULL, 3, _19$$10);
		zephir_check_call_status();
		zephir_throw_exception_debug(_18$$10, "yb/loader/namespacedirectory.zep", 60 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_MM_BOOL(1);

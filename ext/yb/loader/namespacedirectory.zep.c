...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, yb_loader_namespacedirectory_ce, this_ptr, "__construct", &_0, 76, _1);
...
PHP_METHOD(Yb_Loader_NamespaceDirectory, __invoke) {
	...
	ZEPHIR_CALL_CE_STATIC(&_12, yb_loader_loaderabstract_ce, "isloaded", &_13, 77, name);
	zephir_check_call_status();

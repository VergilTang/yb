...
PHP_METHOD(Yb_Tools_SmtpMailer, __construct) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$4, "sprintf", NULL, 48, &_2$$4, _1$$4, port);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_4$$4);
		ZVAL_NULL(_4$$4);
		ZEPHIR_INIT_VAR(_5$$4);
		ZVAL_NULL(_5$$4);
		ZEPHIR_CALL_FUNCTION(&socket, "stream_socket_client", NULL, 57, _3$$4, _4$$4, _5$$4, timeout);
		zephir_check_call_status();
	} else {
		...
		ZVAL_NULL(_8$$6);
		ZEPHIR_CALL_FUNCTION(&socket, "fsockopen", NULL, 58, _6$$6, port, _7$$6, _8$$6, timeout);
		zephir_check_call_status();
	}
	...
	if (_9) {
		...
		ZEPHIR_CALL_FUNCTION(&_11, "constant", NULL, 59, &_10);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_12, "stream_socket_enable_crypto", NULL, 60, socket, ZEPHIR_GLOBAL(global_true), _11);
		zephir_check_call_status();
	...
	ZVAL_LONG(&_10, 1);
	ZEPHIR_CALL_FUNCTION(&_13, "stream_set_blocking", NULL, 61, socket, &_10);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_19, "base64_encode", &_20, 62, _18);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_14);
	...
	ZEPHIR_CALL_FUNCTION(&_22, "base64_encode", &_20, 62, _21);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_14);
...
PHP_METHOD(Yb_Tools_SmtpMailer, sendTo) {
	...
	ZVAL_STRING(&_36, "r", 0);
	ZEPHIR_CALL_FUNCTION(&_37, "gmdate", NULL, 63, &_36);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_38);
	...
	ZEPHIR_INIT_NVAR(_3);
	ZEPHIR_CALL_FUNCTION(&_43, "mt_rand", NULL, 50);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_44, "uniqid", NULL, 51, _43, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	zephir_md5(_3, _44);
	...
	ZEPHIR_CALL_FUNCTION(&_53, "base64_encode", &_54, 62, _52);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_55, "chunk_split", &_56, 64, _53);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_57);
	...
	if (zephir_is_true(attachments)) {
		...
		ZVAL_LONG(&_58$$14, 16);
		ZEPHIR_CALL_FUNCTION(&mine, "finfo_open", NULL, 65, &_58$$14);
		zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_60$$14, &_59$$14)
			...
			ZEPHIR_CALL_FUNCTION(&type, "finfo_file", &_65, 66, mine, path);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_72$$15, "base64_encode", &_54, 62, _71$$15);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&_73$$15, "chunk_split", &_56, 64, _72$$15);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 67, mine);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_NVAR(_48);
	ZVAL_STRING(_48, ".", 1);
...
PHP_METHOD(Yb_Tools_SmtpMailer, cmd) {
	...
	if (_1) {
		...
		ZEPHIR_CALL_FUNCTION(&_4, "fputs", NULL, 68, _2, _3);
		zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_8);
	ZVAL_LONG(&_8, 1024);
	ZEPHIR_CALL_FUNCTION(&_9, "fread", NULL, 69, _7, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Tools_SmtpMailer, pack) {
	...
	if (zephir_fast_strlen_ev(name) > 0) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "base64_encode", NULL, 62, name);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_2$$3);

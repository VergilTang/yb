...
ZEPHIR_INIT_CLASS(Yb_Upload_UploadedFile) {
	...
	ZEPHIR_REGISTER_CLASS(Yb\\Upload, UploadedFile, yb, upload_uploadedfile, yb_upload_uploadedfile_method_entry, 0);

	zend_declare_property_null(yb_upload_uploadedfile_ce, SL("error"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(yb_upload_uploadedfile_ce, SL("size"), ZEND_ACC_PUBLIC TSRMLS_CC);

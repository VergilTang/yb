...
PHP_METHOD(Yb_Upload_Uploader, __construct) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_CALL_FUNCTION(&_5, "preg_split", NULL, 27, &_2, _1, &_3, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "array_flip", NULL, 144, _5);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("validExtensions"), _6 TSRMLS_CC);
	ZEPHIR_CALL_CE_STATIC(&_7, yb_std_ce, "sizetobytes", &_8, 145, maxSize);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Upload_Uploader, newUploadedFile) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 146, this_ptr);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Upload_Uploader, pick) {
	...
	while (1) {
		...
		ZVAL_LONG(&_14$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_15$$3, "pathinfo", &_16, 62, name, &_14$$3);
		zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		while (1) {
			...
			ZVAL_LONG(&_18$$6, 4);
			ZEPHIR_CALL_FUNCTION(&_19$$6, "pathinfo", &_20, 62, name, &_18$$6);
			zephir_check_call_status();

...
PHP_METHOD(Yb_Router_UriPatterns, __construct) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (zephir_fast_strlen_ev(prefix) > 0) {
			...
			ZVAL_STRING(&_8$$5, "#", 0);
			ZEPHIR_CALL_FUNCTION(&_9$$5, "preg_quote", &_10, 107, prefix, &_8$$5);
			zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_12$$3, &_11$$3)
			...
			ZEPHIR_CALL_FUNCTION(&_17$$6, "preg_replace_callback", &_18, 108, _16$$6, callback, _15$$6);
			...
			ZEPHIR_CALL_FUNCTION(&_23$$6, "strtr", &_24, 109, _21$$6, _22$$6);
			zephir_check_call_status();
	...
	if (zephir_is_true(kvs)) {
		...
		ZEPHIR_CALL_FUNCTION(&_28$$7, "array_values", NULL, 22, kvs);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_29$$7, "preg_replace", NULL, 58, _27$$7, _28$$7, uri);
		zephir_check_call_status();
		zephir_get_strval(_30$$7, _29$$7);
		ZEPHIR_CPY_WRT(uri, _30$$7);
	}
	ZEPHIR_CALL_PARENT(NULL, yb_router_uripatterns_ce, this_ptr, "__construct", &_31, 110, uri);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();

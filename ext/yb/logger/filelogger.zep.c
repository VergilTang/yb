...
PHP_METHOD(Yb_Logger_FileLogger, log) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "c", 0);
	ZEPHIR_CALL_FUNCTION(&_1, "date", NULL, 76, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_2, yb_std_ce, "tr", &_3, 77, message, context);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Logger_FileLogger, flush) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, (2 | 8));
	ZEPHIR_CALL_FUNCTION(&_5, "file_put_contents", NULL, 78, _1, _2, &_4);
	zephir_check_call_status();

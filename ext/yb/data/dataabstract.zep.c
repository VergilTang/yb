...
ZEPHIR_INIT_CLASS(Yb_Data_DataAbstract) {
	...
	ZEPHIR_REGISTER_CLASS(Yb\\Data, DataAbstract, yb, data_dataabstract, yb_data_dataabstract_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(yb_data_dataabstract_ce, SL("backend"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(yb_data_dataabstract_ce, SL("identifier"), ZEND_ACC_PROTECTED TSRMLS_CC);

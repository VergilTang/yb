...
PHP_METHOD(Yb_Collection_RedisHashSerialized, serializeValue) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 30, value);
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, unserializeValue) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("unserialize", NULL, 31, value);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, set) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, yb_collection_redishashserialized_ce, this_ptr, "set", &_0, 32, key, _1);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, get) {
	...
	ZEPHIR_CALL_PARENT(&value, yb_collection_redishashserialized_ce, this_ptr, "get", &_0, 33, key);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, setMany) {
	...
	ZEPHIR_CALL_PARENT(NULL, yb_collection_redishashserialized_ce, this_ptr, "setmany", &_5, 34, data);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, getMany) {
	...
	ZEPHIR_INIT_VAR(data);
	array_init(data);
	ZEPHIR_CALL_PARENT(&a, yb_collection_redishashserialized_ce, this_ptr, "getmany", &_0, 35, keys);
	zephir_check_call_status();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, setAll) {
	...
	ZEPHIR_CALL_PARENT(NULL, yb_collection_redishashserialized_ce, this_ptr, "setall", &_5, 36, data);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Yb_Collection_RedisHashSerialized, getAll) {
	...
	ZEPHIR_INIT_VAR(data);
	array_init(data);
	ZEPHIR_CALL_PARENT(&a, yb_collection_redishashserialized_ce, this_ptr, "getall", &_0, 37);
	zephir_check_call_status();

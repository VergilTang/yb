...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_sequence_dbpdomysql_tablecreationquery, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(yb_sequence_dbpdomysql_method_entry) {
	PHP_ME(Yb_Sequence_DbPdoMysql, tableCreationQuery, arginfo_yb_sequence_dbpdomysql_tablecreationquery, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)

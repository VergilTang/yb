...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_factory_classname_arg, 0, 0, 1)
	ZEND_ARG_INFO(0, arg)
...
ZEPHIR_INIT_FUNCS(yb_factory_classname_method_entry) {
	...
	PHP_ME(Yb_Factory_ClassName, args, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Factory_ClassName, arg, arginfo_yb_factory_classname_arg, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Factory_ClassName, getArgArray, NULL, ZEND_ACC_PUBLIC)

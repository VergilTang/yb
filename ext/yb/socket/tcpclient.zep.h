...
ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_socket_tcpclient_readblock, 0, 0, 1)
	ZEND_ARG_INFO(0, len)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_yb_socket_tcpclient_writeblock, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(yb_socket_tcpclient_method_entry) {
	...
	PHP_ME(Yb_Socket_TcpClient, readBlock, arginfo_yb_socket_tcpclient_readblock, ZEND_ACC_PUBLIC)
	PHP_ME(Yb_Socket_TcpClient, writeBlock, arginfo_yb_socket_tcpclient_writeblock, ZEND_ACC_PUBLIC)
	PHP_FE_END
};

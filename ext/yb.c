...
zend_class_entry *yb_rediscluster_error_ce;
...
zend_class_entry *yb_rediscluster_exception_ce;
...
zend_class_entry *yb_rediscluster_client_ce;
zend_class_entry *yb_rediscluster_connection_ce;
zend_class_entry *yb_rediscluster_errorask_ce;
...
static PHP_MINIT_FUNCTION(yb)
{
	...
	ZEPHIR_INIT(Yb_RedisCluster_Client);
	ZEPHIR_INIT(Yb_RedisCluster_Connection);
	ZEPHIR_INIT(Yb_RedisCluster_ErrorAsk);

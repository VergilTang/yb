...
zend_class_entry *yb_redis_apcslotscacher_ce;
zend_class_entry *yb_redis_client_ce;
zend_class_entry *yb_redis_connection_ce;
zend_class_entry *yb_redis_errorask_ce;
zend_class_entry *yb_redis_errormoved_ce;
zend_class_entry *yb_redis_fileslotscacher_ce;
zend_class_entry *yb_redis_socketexception_ce;
...
static PHP_MINIT_FUNCTION(yb)
{
	...
	ZEPHIR_INIT(Yb_Redis_ApcSlotsCacher);
	ZEPHIR_INIT(Yb_Redis_Client);
	ZEPHIR_INIT(Yb_Redis_Connection);
	ZEPHIR_INIT(Yb_Redis_ErrorAsk);
	ZEPHIR_INIT(Yb_Redis_ErrorMoved);
	ZEPHIR_INIT(Yb_Redis_FileSlotsCacher);
	ZEPHIR_INIT(Yb_Redis_SocketException);
